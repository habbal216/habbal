          ...
          <div className="mt-5xlarge flex w-full max-w-[664px] flex-col">
            ...
            <p className="text-grey-50">
              {t(
                ...
                "To create the most compelling e-commerce experience we would like to gain insights in how you use Habbal. User insights allow us to build a better, more engaging, and more usable products. We only collect data for product improvements. Read what data we gather in our"
              )}{" "}
              <a
                href="#"
